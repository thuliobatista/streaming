...
<?php
  ...
  $codfilme = $_GET["cod"];
  $sql =  "SELECT
  f.*, GROUP_CONCAT(a.NOME) AS nomeAtor,
  (
    SELECT
    ...
    FROM
      genero
    WHERE
      CODGENERO IN (f.CODGENERO, f.SUBGENERO)
  ) AS GENERO
  FROM
  filmes f
  INNER JOIN atuacaofilme af ON f.CODFILME = af.CODFILME
  INNER JOIN ator a ON a.CODATOR = af.CODATOR
  WHERE f.CODFILME = '$codfilme'";
  ...
  <main>
    <section class="conteudo">
      <div class="conteudo-texto">
        ...
        <div class="descricao">
          <p id="dados"><span id="idade"><?php echo $classificacao;?></span> <?php echo $ano;?> &bull;</p>
